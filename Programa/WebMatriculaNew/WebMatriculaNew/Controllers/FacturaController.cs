...
namespace WebMatriculaNew.Controllers
{
    public class FacturaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CedulaPadre,Periodo,Anno,FechaPago,MontoTotal,CedulaEstudiante")] Factura factura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CedulaPadre,Periodo,Anno,FechaPago,MontoTotal,CedulaEstudiante")] Factura factura)
        {

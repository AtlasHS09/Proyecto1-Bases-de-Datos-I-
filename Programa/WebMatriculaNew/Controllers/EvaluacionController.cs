...
namespace WebMatriculaNew.Controllers
{
    public class EvaluacionController : Controller
    {
        ...
        {
            var matriculaContext = _context.Evaluacions.Include(e => e.CursoNavigation);
        ...
        {
            ViewData["Curso"] = new SelectList(_context.CursoProfesors, "CodigoCurso", "NombreCurso");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CodigoEvaluacion,Evaluacion1,Porcentaje,Curso")] Evaluacion evaluacion)
        {
            ...
            ViewData["Curso"] = new SelectList(_context.CursoProfesors, "CodigoCurso", "NombreCurso", evaluacion.Curso);
            return View(evaluacion);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CodigoEvaluacion,Evaluacion1,Porcentaje,Curso")] Evaluacion evaluacion)
        {

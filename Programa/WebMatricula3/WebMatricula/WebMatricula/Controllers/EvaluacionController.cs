...
namespace WebMatricula.Controllers
{
    public class EvaluacionController : Controller
    {
        ...
        {
            ViewData["Curso"] = new SelectList(_context.HorarioClases, "CodigoCurso", "NombreCurso");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CodigoEvaluacion,Evaluacion1,Porcentaje,Curso")] Evaluacion evaluacion)
        {
            ...
            ViewData["Curso"] = new SelectList(_context.HorarioClases, "CodigoCurso", "NombreCurso", evaluacion.Curso);
            return View(evaluacion);
        }
